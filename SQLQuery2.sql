...
create table FACULTY_SUBJECT(
	...
	constraint fs_pk primary key (EmpID, SubjectCode),
...
select empid from faculty where userid = 4;

update FACULTY set 
MName = 'Zachary', LName = 'Limenedes', Position = 'Dean', EmpRank = 'Prof V', SupervisorID = '8002', UserID = '3'
where EmpID = '8001'

update FACULTY set 
MName = 'Evangelista', LName = 'De Jesus', Position = 'Asst Dean', EmpRank = 'Prof IV', SupervisorID = '8001', UserID = '4'
where EmpID = '8002'

update FACULTY set 
MName = 'Bautista', LName = 'Manlapaz', Position = 'Faculty', EmpRank = 'Instructor IV', SupervisorID = '8001', UserID = '5'
where EmpID = '8003'

update FACULTY set 
MName = 'Roque', LName = 'Cruz', Position = 'Faculty', EmpRank = 'Instructor I', SupervisorID = '8001', UserID = '6'
where EmpID = '8004'

update FACULTY set 
MName = 'Santos', LName = 'Lopez', Position = 'Faculty', EmpRank = 'Instructor II', SupervisorID = '8001', UserID = '7'
where EmpID = '8005'

update FACULTY set 
MName = 'Quervo', LName = 'Rodriguez', Position = 'Faculty', EmpRank = 'Instructor III', SupervisorID = '8001', UserID = '8'
where EmpID = '8006'
...
values ('IT-206', 'Advanced Database Systems', '2', '1', '3', 'T 1:00 PM - 4:00 PM', 'BSIT', 8001),
('IT-207', 'Object Oriented Programming', '2', '1', '3', 'F 10:00 AM - 1:00 PM', 'BSIT', 8001),
('IT-208', 'Platform Technologies', '2', '1', '3', 'F 7:00 AM - 10:00 AM', 'BSIT', 8001),
('IT-209', 'Interactive Systems and Technologies', '2', '1', '3', 'TH 2:00 PM - 5:00 PM', 'BSIT', 8001),
('IT-210', 'Networking 2', '2', '1', '3', 'TH 10:00 AM - 1:00 PM', 'BSIT', 8001)
